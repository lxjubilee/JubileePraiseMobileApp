// Supported UI/catalog languages for JubileePraise — ported verbatim from the web
// app (jubileepraise.com `lib/languages.ts`) so mobile and web filter identically.
//
