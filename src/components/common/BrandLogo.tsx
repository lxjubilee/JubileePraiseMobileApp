...
/**
 * Wordmark span colors, mirrored from the JubileePraise.com web header: the outer
 * words are white and the middle highlight is the brand azure blue (the same
