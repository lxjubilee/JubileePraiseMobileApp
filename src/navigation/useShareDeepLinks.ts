...
/**
 * Handles incoming share/deep links (e.g. https://jubileepraise.com/album?c=CODE or
 * jubileepraise://album/CODE): navigate to that album. Sharing is album-level, so a
