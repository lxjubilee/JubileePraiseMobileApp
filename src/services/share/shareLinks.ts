 ...
 *
 * The canonical share URL is an https link to the JubileePraise.com album page,
 ...
 * the app to the album when installed (universal / App Links on jubileepraise.com),
...
const WEB_HOST = 'jubileepraise.com';
 ...
 * the custom-scheme variants, and the legacy `jubileepraise://track/<id>` form
