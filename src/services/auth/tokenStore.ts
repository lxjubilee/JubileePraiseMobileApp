 ...
 */
const KEY_ACCESS = 'jubileepraise.auth.accessToken';
const KEY_REFRESH = 'jubileepraise.auth.refreshToken';
const KEY_EXPIRES = 'jubileepraise.auth.expiresAt';
const KEY_USER = 'jubileepraise.auth.user';
